...
function jiaCai(){
	...
	setAttributes(foodInput,{class:"input_food",type:"text",placeholder:"食物"+String(foodNum),id:"input_food"+String(foodNum),required:"required"});
	listNode.appendChild(foodInput);
	document.getElementById('button_jianCai').setAttribute("style","visibility:visible;");
	listNode.appendChild(document.getElementById('button_jianCai'));
...
function jianCai(){
	...
	var button_jianCai = document.getElementById('button_jianCai');
	foodNum--;
	if(foodNum <=2)
	{
		document.getElementById('button_jianCai').setAttribute("style","visibility:hidden;");
		document.getElementById('form_foodInput').appendChild(button_jianCai);
	}
	else
		document.getElementById("li_foodInput"+String(foodNum)).appendChild(button_jianCai);
